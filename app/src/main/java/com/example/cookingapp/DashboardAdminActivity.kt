...
import com.example.cookingapp.databinding.ActivityDashboardAdminBinding
...
class DashboardAdminActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.addDetailBtn.setOnClickListener {
            startActivity(Intent(this,DetailAddActivity::class.java))
        }
